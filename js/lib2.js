var ConnectFour = /** @class */ (function () {
    ...
    ConnectFour.prototype.getColumnsDOM = function () {
        ...
        return this.columns
            .map(function (column, i) { return "<div class=\"column\"> " + _this.getColumnDOM(i) + " </div>"; })
            .join("");
    };
    ConnectFour.prototype.getColumnDOM = function (column) {
        return this.columns[column]
            .map(function (i) { return "<div class=\"disc " + i + "\"> " + i + " </div>"; })
            .reverse()
            .join("");
    };
    ...
    ConnectFour.prototype.dropByCurrentPlayer = function (column) {
        ...
        if (addedToRow > 0) {
            ...
            var allColumnsFilled = this.columns.every(function (i) { i.length === 6; });
